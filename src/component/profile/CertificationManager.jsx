      ...
      <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 mb-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-6">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-800">Certifications</h1>
          </div>
          <button
            onClick={() => {
            ...
            className="w-full sm:w-auto bg-purple-600 hover:bg-purple-700 text-white p-3  rounded-lg transition-colors"
          >
        ...
        {showForm && (
          <div className="bg-gray-50 p-4 sm:p-6 rounded-lg mb-6 space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button
                ...
                className="w-full sm:w-auto bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg transition-colors"
              >
              ...
              <button
                ...
                className="w-full sm:w-auto bg-gray-300 hover:bg-gray-400 text-gray-700 px-6 py-2 rounded-md transition-colors"
              >
                Cancel
              </button>
            </div>
        ...
        {certifications.length > 0 && (
          <div className="space-y-6">
            ...
            {certifications.map((certification) => {
              ...
              return (
                <div key={certification.id} className="bg-white border border-gray-200 rounded-lg p-4 sm:p-6 hover:shadow-md transition-shadow">
                  <div className="flex flex-col md:flex-row justify-between items-start mb-4 gap-4">
                    <div className="flex-1">
                      ...
                      <p className="text-base sm:text-lg text-purple-600 font-medium mb-2">
