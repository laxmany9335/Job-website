                ...
                <div className="w-full max-w-[550px] flex flex-col gap-3">
                  ...
                  <div className="flex flex-col gap-3 mb-1">
                    <button
                      ...
                      className={`w-full py-2 rounded-full text-white text-sm font-medium transition ${isFormValid ? "bg-[#1976D2] hover:bg-[#1565C0] cursor-pointer" : "bg-gray-300 cursor-not-allowed"}`}
                    >
                      Sign Up
                    </button>
